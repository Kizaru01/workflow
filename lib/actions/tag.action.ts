...
import {
  ActionResponse,
  ErrorResponse,
  GegTagQuestionParams,
  PaginatedSearchParams,
  QuestionProps,
  Tags,
} from "@/types";
import { GetTagQuestionSchema, PaginatedSearchSchema } from "../zod";
...
export async function getTagQuestion(
  params: GegTagQuestionParams
): Promise<
  ActionResponse<{ tag: Tags; questions: QuestionProps[]; isNext: boolean }>
> {
  const validationResult = await action({
    params,
